...
class MultiWorld:
    ...
    def money(self, virus, country, rent_r):
        ...
        """
        return round(self.infected[virus.name, country]
    ...
    def spread(self, virus, country, inf_r, dest_r, prot_r, rent_r):
        ...
        sane      = self.sane[virus.name, country]
        infected  = self.infected[virus.name, country]
        destroyed = self.destroyed[virus.name, country]
        protected = self.protected[virus.name, country]
        ...
        self.sane[virus.name, country]      = sane
        self.infected[virus.name, country]  = infected
        self.protected[virus.name, country] = protected
        self.destroyed[virus.name, country] = destroyed
